        ...
        <div className="container">
          ...
          <div className="faq-list">
            {[
              ...
              { q: 'How long does an Accoya door take to make?', a: 'Lead times depend on complexity and current order book, but typically 10–12 weeks from order to delivery. We\'ll give you a firm lead time at quotation.' },
